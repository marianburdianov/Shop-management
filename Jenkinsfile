    ...
    stages {
        ...
        stage("Newman Test") {
            steps {
                ...
                bat "C:/Users/maria/AppData/Roaming/npm/newman run --disable-unicode https://www.getpostman.com/collections/4ed4489c4178ef86bfe4 --reporters html --reporter-html-export D:/MarianOptimal/PostmanCollection/newman/report.html"
            }
        }
